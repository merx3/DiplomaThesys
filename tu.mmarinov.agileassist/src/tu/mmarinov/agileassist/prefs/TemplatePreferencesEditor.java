...
public class TemplatePreferencesEditor {
	 ...
	 */	
	public static void populatePreferenceDefaultTemplates(ArrayList<AgileTemplate> templates) {
	...
	public static ArrayList<AgileTemplate> loadTemplatesFromPreferences() {
